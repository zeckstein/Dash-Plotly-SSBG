    ...
    [
        ...
        html.Footer(
            [
                ...
                html.P(
                    [
                        "Created by Zachary Eckstein | Contact: ",
                        html.A(
                            "zacheckstein@live.com",
                            href="mailto:zacheckstein@live.com",
                            style={"textDecoration": "none"},
                        ),
                        " | GitHub: ",
                        html.A(
                            "zeckstein",
                            href="https://github.com/zeckstein",
                            target="_blank",
                        ...
                        html.A(
                            "Zachary Eckstein",
                            href="https://www.linkedin.com/in/zachary-eckstein-3b908a118/",
                            target="_blank",
                            rel="noopener noreferrer",
                        ),
                    ],
...
@callback(Output("state-name-store", "data"), Input("url", "pathname"))
