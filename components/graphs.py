...
def create_time_series_line_chart(df, x_col='year', y_col='value', color_col='service_category', 
                                   title='Time Series', x_title='Year', y_title='Value'):
    """
...
def create_bar_chart(df, x_col, y_col, title='Bar Chart', x_title='Category', y_title='Value', 
                     orientation='v', color_col=None):
    """
    Create a bar chart
